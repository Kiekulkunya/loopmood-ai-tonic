...
const FA = [3,3,2,2,3,4,5,2,1,2,1,1,2,5,2,1,3,2,2,2,2,2,2];
const FB = [2,2,2,2,2,2,2,2,5,5,5,5,5,5,4,3,2,3,2,4,4,4,4];
const FC = [1,2,2,1,3,2,1,1,3,2,4,1,2,5,2,2,3,4,3,5,3,3,3];
